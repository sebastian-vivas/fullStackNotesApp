...
## :watermelon: Setting up NodeJS on your system and in the application
...
## :grapes: Setting up React in the application
...
## :lemon: Running unit tests in the server folder

* `npm test` -> Runs all of the unit tests.

## :pineapple: Running unit tests in the client folder
...
### :blueberries: Environments

* development - local development

## :cherries: Tools/Libraries
...
## :mango: Why are unit tests important? What is test driven development?
...
## :tangerine: Things that aren't worth testing
...
### :kiwi_fruit: Tutorials & Resources
